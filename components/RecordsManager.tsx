                        ...
                        <tbody className="bg-white dark:bg-slate-800 divide-y divide-slate-200 dark:divide-slate-700 text-sm">
                            {filteredAndSortedRecords.map(record => (
                                <tr 
                                    ...
                                    className={`cursor-pointer transition-colors ${playingRecordId === record.id ? 'bg-indigo-50 dark:bg-indigo-900/50' : 'hover:bg-slate-50 dark:hover:bg-slate-700/50'}`}
                                >
                                    ...
                                    <td className="px-4 py-2 text-right">
                                        <button onClick={(e) => e.stopPropagation()} className="text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-300 inline-flex items-center gap-1">
